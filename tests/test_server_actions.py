...
class TestActionRegistry:
    ...
    def test_execute_requires_auth(self):
        registry = ActionRegistry()
        registry.register("private_action", lambda args, session=None: "data", require_auth=True, require_csrf=False)
        result = registry.execute("private_action", {}, session=None, csrf_token="")
        assert result["ok"] is False
