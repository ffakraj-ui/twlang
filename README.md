...
- **Lib directory** — shared server-side functions via `lib/` folder (`.twm` files). Call them in `let` statements: `let app = getApps(slug)`. Build-time execution via Node.js. See [Lib Directory docs](docs/21-lib-directory.md)
